...
public class ServerController implements IServerController {
    ...
    public ServerController() throws RemoteException, SQLException {
...
//		iClientController = (IClientController) Naming.lookup("rmi://localhost:1099/iClientController");
    ...
    @Override
    public ArrayList<Owner> executeOwnerRelationRequest() throws SQLException {
        return ownerModelManager.assembleArrayList();
    }

    @Override
    public void executeCostInsert(Cost cost) throws SQLException {
